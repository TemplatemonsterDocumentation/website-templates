    ...
    <div class="rd-mobilemenu active">
        ...
        <div class="panel">
            <div class="select select-version">
                <select>
                    <option data-href="#" selected>Version v3-0</option>
                    <option data-href="/help/quick-start-guide/website-templates/responsive-website-templates-v1-2/">Version v1-2</option>
