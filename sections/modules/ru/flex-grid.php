...
<p>Intense использует специально подготовленную Flex Grid систему. Данная система предоставляет более гибкое и комплексное решение по сравнению с Bootstrap Grid. </p>
<p>Различные аспекты работы Flex Grid системы по умолчанию представлены в следующей таблице:</p>
...
<table class="table table--skin-1">
    ...
    <tr>
        <td>Управление горизонтальным выравниванием</td>
        <td>Нет</td>
        <td colspan="5">Да</td>
    </tr>
    <tr>
...
<h4>Вложенные колонки</h4>
<p>Для реализации вложенности колонок в Grid-системе, добавьте новый <b>.range</b> и набор целевых колонок <b>.cell-*-*</b> в уже существующую колонку. </p>
...
<ul class="marked-list">
    <li>
        <dl class="inline-term">
            <dt>.range-*-top</dt>
            <dd>прижимает все вложенные колонки 1 уровня к верху;</dd>
        </dl>
    </li>
</ul>
<table class="table">
...
<h4>Управление порядком вывода колонок</h4>
<p>Для того чтобы изменить порядок отображения элементов сетки, необходимо воспользоваться классом <b>.cell-RS-push-X</b>, где <b>RS</b> - целевое разрешение, <b>X</b> - порядок. Например:</p>
<pre><code>
        &lt;div class="range"&gt;
...
<p class="alert alert-info">Обратите внимание: в случае использования классов для управления порядком вывода колонок, обязательно необходимо определять порядок всех элементов в строке.</p>