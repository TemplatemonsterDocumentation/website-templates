...
<p class="alert alert-info">Обратите внимание: в случае использования классов для управления порядком вывода колонок, обязательно небходимо определять порядок всех элементов в строке.</p>