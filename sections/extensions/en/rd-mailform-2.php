<h3>RD Mailform v2. Mail form.</h3>
...
<p class="alert alert-info">Attention: in RD Mailform, <b>&lt;input type="email" name="email"&gt;</b> is required for the correct functioning of the form. If the field is not present, you will get an error, when submitting a form. </p>
...
<pre><code>&lt;form class='rd-mailform' data-form-type="contact" method="post" action="bat/rd-mailform.php"&gt;
  ...
&lt;/form&gt;</code></pre>
...
&lt;div class="form-wrap"&gt;
  ...
  &lt;input id="contact-us-name" type="text" name="name" data-constraints="@Required" class="form-input"&gt;
&lt;/div&gt;
...</code></pre>
  </li>
  ...
  <li>
    <p>Date and time selection menu. This menu supports 3 display types:</p>
...
...</code></pre>
  ...
  <li>
    <p>Simple selection menu;</p>
    <pre><code>...
&lt;div class="form-wrap"&gt;
  &lt;label for="select" class="form-label form-label-outside"&gt;Gender:&lt;/label&gt;
  &lt;select id="select" data-placeholder="Select an option" data-minimum-results-for-search="Infinity" class="form-input"&gt;
    &lt;option&gt;Male&lt;/option&gt;
