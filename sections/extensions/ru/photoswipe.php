<h3>Photoswipe</h3>
<p>ntense использует расширение <b>Photoswipe.js</b> для реализации красивых и mobile-friendly галлерей.</p>
...
<p>Для вставки модального окна c отдельным изображением воспользуйтесь дата атрибутом
    <b>data-photoswipe-item</b> для соответствующей ссылки и атрибутом <b>data-size</b> для указания размерка большой картинки в формате <b>WxH</b>.</p>
