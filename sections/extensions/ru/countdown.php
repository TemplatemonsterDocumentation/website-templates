<h3>Счётчик обратного отсчёта</h3>
<p>Intense использует расширение <b>jQuery Countdown</b> для реализации счётчика.</p>
<h4>Добавление счётчика на страницу</h4>
<p>Для добавления счётчика обратного отсчета на целевую HTML-страницу, необходимо воспользоваться следующей разметкой:</p>
...
<ol class="index-list">
    <li>
        <dl class="inline-term">
            <dt>until</dt>
            <dd>счётчик ведет отсчет времени до указанной в <b>data-time</b> даты.</dd>
        </dl>
    </li>
    <li>
        <dl class="inline-term">
            <dt>since </dt>
            <dd>счётчик ведет отсчет времени с указанной в  <b>data-time</b> даты</dd>
        </dl>
    </li>
</ol>
...
<p>где <b>month</b> - это месяц, который может иметь следующие значения:
</p>
...
<h4>Настройка формата отображения счётчика</h4>
<p>Для того чтобы задать формат отображения счётчика на странице, нужно добавить атрибут <b>data-format</b>.</p>
<p>Используйте следующие символы (в указанном порядке), чтобы указать какие периоды Вы хотите отобразить: <b>"Y"</b> - в течение многих лет, <b>"O"</b> - в
    течение нескольких месяцев, <b>"W"</b> - в течение нескольких недель, <b>"D"</b> - в течение нескольких дней, <b>"H"</b> - в течение нескольких часов, <b>"М"</b> - за несколько минут, <b>"S"</b> - за несколько секунд.
</p>
<p>Например:</p>
<pre><code>
...
<p>В данном случае счётчик будет иметь следующий формат:</p>
