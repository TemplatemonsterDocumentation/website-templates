...
<p>Для того, чтобы зациклить отображение слайдов в слайдере необходимо воспользоваться дата атрибутом <b>data-loop</b> (true/false, по-умолчанию true) для целевого элемента с классом <b>.slick-slider</b>.
</p>
<p>Например,</p>
<pre><code>
