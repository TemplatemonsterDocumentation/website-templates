...
<h5>Благодарим Вас за приобретение шаблона веб-сайта. Данное руководство покажет, как работать с шаблоном, как его
...
<h3>Что такое Website Template?</h3>

<p><b>Website Template</b> – это качественно свёрстанный вручную набор страниц. Контент всех страниц написан на HTML, а
    динамическая анимация на JavaScript.</p>

<h3>Подготовка</h3>

<p>Прежде чем перейти к установке Website Template, нужно
...
<ol class="index-list">
    ...
    <li>Также может понадобиться программа Adobe Photoshop (версии CS3 или выше). Она используется для редактирования исходных файлов .PSD и
    ...
    <li>Чтобы загрузить файлы на хостинг сервер, потребуется FTP менеджер, например “файловый менеджер в админке вашего хостинг-провайдера” или десктопные приложения, такие как Total Commander, FileZilla, CuteFTP
        и т.д.
    </li>
</ol>
...
<p>Также можно установить Website Template на компьютер при помощи локального сервера. Для
...
<p class="alert alert-info">HTML и CSS файлы шаблона семантически корректны. Однако могут возникать некоторые ошибки
    ...
    дружественный продукт, для этого иногда приходится использовать новые, ещё не принятые как стандарт правила, которые отлично работают во всех браузерах, но пока не являются валидными.</p>