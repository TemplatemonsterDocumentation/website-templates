...
<h5>Благодарим Вас за приобретение шаблона Bootstrap Template. Данное руководство покажет, как работать с шаблоном, как его
...
<h3>Что такое Bootstrap Template?</h3>

<p><b>Bootstrap Template</b> - это качественно свёрстанный вручную набор страниц, который включает в себя свободный набор
    инструментов для создания сайтов и веб-приложений. Контент всех страниц написан на HTML, а динамическая анимация на
    JavaScript.</p>

<h3>Подготовка</h3>

<p>Прежде чем перейти к установке Bootstrap Template, нужно
...
<p>При наличии активного сервера, нужно проверить его на соответствие требованиям Bootstrap Template, указанным на
    странице шаблона. В большинстве шаблонов обязательным требованием является только PHP 5.4 и выше.</p>

<p>Также можно установить Bootstrap Template на компьютер при помощи локального сервера. Для
        ...
        <ul>
            <li class="file">
                <dl class="inline-term">
                    ...
                    <dd>содержит полезные скрипты и бонусные дополнения.</dd>
                </dl>
            </li>
            <li class="file">
                <dl class="inline-term">
        ...
        <ul>
            ...
            <li class="file">
                <dl class="inline-term">
                    ...
                    <dd>содержит файлы .less LESS, используемые в шаблоне.</dd>
                </dl>
            </li>
        </ul>
    </li>
