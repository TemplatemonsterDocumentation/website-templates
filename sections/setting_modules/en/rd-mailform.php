...
<p>You can use any form elements, presented on the <b>Components > Toolkit Components > Form Elements</b> page, for implementing
  custom forms with a custom set of fields. You can also use any Bootstrap form-related elements that can be found on the
	<a href="https://getbootstrap.com/docs" target="_blank">Bootstrap Official Website</a> , and Bootstrap Grid and  Flex Grid elements for implementing custom form structure.
</p>
...
<code>"recipientEmail": "test@demolink.com test2@demolink.com"</code>
...
&lt;div class="form-wrap"&gt;
    ...
    &lt;input id="rd-mailform-time" type="text" name="time" date-time-picker="time" class="form-input"&gt;
&lt;/div&gt;
...
                    </code></pre>
    </li>
...
...
&lt;div class="form-wrap"&gt;
    &lt;select data-placeholder="Select an option" name="gender" data-minimum-results-for-search="Infinity" class="form-input"&gt;
        &lt;option&gt;Male&lt;/option&gt;
...
&lt;div class="form-wrap"&gt;
    ...
    &lt;textarea id="message" name="message" data-constraints="@Required" class="form-input"&gt;&lt;/textarea&gt;
&lt;/div&gt;
...
        </code></pre>
    </li>
...
<p><a href="index.php?lang=en&section=template_customization#mailform-settings">Instruction</a></p>
...
<ol class="index-list">
  <li>
    <p>Register your domain at  <a href="https://www.google.com/recaptcha/admin#list" target="_blank">Google reCaptcha</a> website and get a pair of API-keys (a pair of keys consists of
...
<p> You can find more detailed instructions at <a href="https://developers.google.com/recaptcha/docs/start" target="_blank">Google ReCaptcha</a> official website.</p>
