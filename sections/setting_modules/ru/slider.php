...
<p>Для того, чтобы включить/выключить автопроигрывание слайдов в слайдере необходимо в файле инициализации скриптов tm-scripts.js в коде инициализации скрипта:</p>
