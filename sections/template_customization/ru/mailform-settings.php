...
<p>Для того, чтобы указать email адрес, на который будут приходить сообщения, отправляемые с помощью <b>RD Mailform</b> необходимо в файле <b>bat/rd-mailform.php</b> вашего сайта заменить email, указанный в переменной <b>$recipients</b>, на соответствующий email  получателя.
</p>
