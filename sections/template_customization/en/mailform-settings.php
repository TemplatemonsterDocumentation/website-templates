...
<p>    HTML Website Template uses a set of <b>RD Mailform</b> plugins  for implementing contact forms.
	You can find more detailed instructions about these plugins in <b><a href="index.php?lang=en&section=setting_modules#rd-mailform">Extensions > RD Mailform</a></b> section.</p>
...
<img src="img/mailform-4.jpg" alt="">
...
<div class="alert alert-info">
	<p>To configure smtp through gmail, you need to give access to <a
			href="https://support.google.com/accounts/answer/6010255" target="_blank">unreliable applications</a></p>
</div>